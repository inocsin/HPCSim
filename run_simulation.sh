...
do
    ...
    do
        ...
        python $SCRIPT_HOME/FatTreeAuto.py  --injection_rate=$injection --pass_through_latency=0 --link_latency=5 --baseline=0 --buffer=32 --freq=3500000000 --datarate=$datarate --traffic=1 --hotspot=2.0
